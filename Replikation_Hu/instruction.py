...
class Instruction:
    ...
    def initalHellos(self):
        text_stim_1 = visual.TextStim(self.win, height=0.085)
        text_stim_1.setText(
        ...
        text_stim_2 = visual.TextStim(self.win, height=0.085)                              # text stimuli self.win aus Zeile 15
        text_stim_2.setText(
    ...
    def instruction_for_phase_1(self):
        text_stim = visual.TextStim(self.win, height=0.085)                              # text stimuli self.win aus Zeile 15
        text_stim.setText(
    ...
    def instruction_for_phase_2(self):
        text_stim_1 = visual.TextStim(self.win, height=0.085)                              # text stimuli win aus Zeile 15
        text_stim_1.setText(
        ...
        text_stim_2 = visual.TextStim(self.win, height=0.085)                              # text stimuli win aus Zeile 15
        text_stim_2.setText(
    ...
    def say_goodbye(self):
        text_stim = visual.TextStim(self.win, height=0.085)                              # text stimuli win aus Zeile 15
        text_stim.setText(
